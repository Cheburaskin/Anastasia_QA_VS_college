...
while True: 
    ...
    if len(input_string_2) >= 5:
        ...
        print("The string length is: ", len(input_string_2))
...
if len(input_string_4) == 0:
    print("Error: empty string.")
else:
    if input_string_4[0]=="A":
        replaced_string_4 = "a" + input_string_4[1:]
        print("Replaced string:", replaced_string_4)
